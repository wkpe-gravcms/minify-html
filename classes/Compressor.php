...
namespace Grav\Plugin\MinifyHtml;
 ...
 * [HTML compressor]
 *
 * [minify HTML output inluding inline script and style]
 *
 * Class Compressor
 * @package Grav\Plugin
...
class Compressor
{
   ...
   */
    ...
    /**
     * Instantiate Compressor class
     */
    public function __construct()
    {
        $this->mincss = Grav::instance()['config']['plugins.minify-html']['mincss'];
        $this->minjs = Grav::instance()['config']['plugins.minify-html']['minjs'];
    }
    ...
    public function minifyHtml($input) {
        ...
        // Minify inline JS declaration(s)
        if($minjs) {
